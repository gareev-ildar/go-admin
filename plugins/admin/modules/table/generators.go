...
import (
	...
	"github.com/gareev-ildar/go-admin/modules/collection"
	"github.com/gareev-ildar/go-admin/modules/config"
	"github.com/gareev-ildar/go-admin/modules/db"
	"github.com/gareev-ildar/go-admin/modules/db/dialect"
	errs "github.com/gareev-ildar/go-admin/modules/errors"
	"github.com/gareev-ildar/go-admin/modules/language"
	"github.com/gareev-ildar/go-admin/modules/logger"
	"github.com/gareev-ildar/go-admin/modules/ui"
	"github.com/gareev-ildar/go-admin/modules/utils"
	"github.com/gareev-ildar/go-admin/plugins/admin/models"
	...
	"github.com/gareev-ildar/go-admin/plugins/admin/modules/tools"
	...
	"github.com/gareev-ildar/go-admin/template/types/form"
	selection "github.com/gareev-ildar/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/gareev-ildar/go-admin/modules/db/dialect", Value: "github.com/gareev-ildar/go-admin/modules/db/dialect"},
			{Text: "github.com/gareev-ildar/go-admin/modules/db", Value: "github.com/gareev-ildar/go-admin/modules/db"},
			{Text: "github.com/gareev-ildar/go-admin/modules/language", Value: "github.com/gareev-ildar/go-admin/modules/language"},
			{Text: "github.com/gareev-ildar/go-admin/modules/logger", Value: "github.com/gareev-ildar/go-admin/modules/logger"},
		}).
		FieldDefault("").
